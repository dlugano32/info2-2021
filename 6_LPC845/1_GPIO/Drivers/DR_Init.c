...
void InitGPIO(void)
{
	...
	//3-Configuro el boton como salida y le pongo un pull up--> Puerto 0/ pin 4
	SetDIR(BOTON_STICK, ENTRADA);
	SetPINMODE_IN( IOCON_INDEX_PIO0_4, 0x02);

	//4-Configuro todos los botones que estan como salidas con el open drain OFF

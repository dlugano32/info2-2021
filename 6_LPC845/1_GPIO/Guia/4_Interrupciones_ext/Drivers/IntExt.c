...
void InitIntExt(void)
{
	...
	INT_EXT->IENR&= ~(0x01<<FUENTE_INT_0);	//Deshabilito la deteccion por flanco ascendente
	INT_EXT->IENF|= (0x01<<FUENTE_INT_0);	//Habilito la deteccion por flanco descendente
